...
const Homepage = () => {
  ...
  return (
    <div className="home">
      ...
      <div className="whatsapp-chat-button-fixed">
        <a 
          ...
          className="whatsapp-link-fixed"
          aria-label="Chat with us on WhatsApp"
        >
          <div className="whatsapp-icon-wrapper-fixed">
            <svg className="whatsapp-icon-fixed" viewBox="0 0 24 24" fill="currentColor">
          ...
          <span className="whatsapp-text-fixed">Chat with us on WhatsApp</span>
        </a>
      </div>
    </div>
  );
